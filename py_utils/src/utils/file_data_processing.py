...
def unzip_all_folders(
    input_dir_path="data/DOC/EPNWA1", output_dir_path="data/DOC/EPNWA1", limit=99999
):
...
def unzip_all_subfolders(
    input_dir_path="data/DOC", output_dir_path="data/DOC-UNPACKED"
):
    ...
    for folder in tqdm(os.listdir(input_dir_path)):
        ...
        unzip_all_folders(
            input_dir_path=f"{input_dir_path}/{folder}",
            output_dir_path=f"{output_dir_path}/{folder}",
            limit=99999,
        )
